...
z=exp(1i*Omega);                  %Define z on unit circle
T=0.001;
H=((z.^5-1.89353*z.^4+1.70189*z.^3-0.843832*z.^2+0.2302*z-0.0272007)./(0.297046*z.*(z.^4-0.982666*z.^3+0.712641*z.^2-0.221309*z+0.0553271)));
...
for T = 0.1:0.1:1
    w = T*((z.^5-1.89353*z.^4+1.70189*z.^3-0.843832*z.^2+0.2302*z-0.0272007)./(0.297046*z.*(z.^4-0.982666*z.^3+0.712641*z.^2-0.221309*z+0.0553271)));
    hold on
    figure(3)
    plot(real(w),imag(w))
